...
RUN C:\Program^ Files^ ^(x86^)\Android\android-sdk\cmdline-tools\11.0\\bin\sdkmanager.bat --install "platforms;android-28" "platforms;android-34" --sdk_root="C:\Program Files (x86)\Android\android-sdk"
